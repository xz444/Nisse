...
Gui Add, Button, x35 y500 w625 h60 gGenerateConfig, Save / Reload
...
Gui, Add, GroupBox, x35 y59 w80 h60, Recruit
Gui, Add, Edit, x45 y80 w60 h30 vRecruit, 1
Gui, Add, CheckBox, x35 y125 vRecruit1, Enable

Gui, Add, GroupBox, x130 y59 w80 h60, Recruit2
Gui, Add, Edit, x140 y80 w60 h30 vRecruit2, 1
Gui, Add, CheckBox, x130 y125 vRecruit22, Enable

Gui, Add, GroupBox, x225 y59 w80 h60, Recruit3
Gui, Add, Edit, x235 y80 w60 h30 vRecruit3, 1
Gui, Add, CheckBox, x225 y125 vRecruit33, Enable

Gui, Add, GroupBox, x320 y59 w80 h60, Recruit4
Gui, Add, Edit, x330 y80 w60 h30 vRecruit4, 1
Gui, Add, CheckBox, x320 y125 vRecruit44, Enable

Gui, Add, GroupBox, x415 y59 w80 h60, Recruit5
Gui, Add, Edit, x425 y80 w60 h30 vRecruit5, 1
Gui, Add, CheckBox, x415 y125 vRecruit55, Enable

Gui, Add, GroupBox, x510 y59 w80 h60, Recruit6
Gui, Add, Edit, x520 y80 w60 h30 vRecruit6, 1
Gui, Add, CheckBox, x510 y125 vRecruit66, Enable

Gui, Add, GroupBox, x605 y59 w80 h60, Recruit7
Gui, Add, Edit, x615 y80 w60 h30 vRecruit7, 1
Gui, Add, CheckBox, x605 y125 vRecruit77, Enable

IniFile := "config\config.ini"
GuiControl,, Recruit, % GetIniValue(IniFile, "Recruits", "Recruit")
GuiControl,, Recruit2, % GetIniValue(IniFile, "Recruits", "Recruit2")
GuiControl,, Recruit3, % GetIniValue(IniFile, "Recruits", "Recruit3")
GuiControl,, Recruit4, % GetIniValue(IniFile, "Recruits", "Recruit4")
GuiControl,, Recruit5, % GetIniValue(IniFile, "Recruits", "Recruit5")
GuiControl,, Recruit6, % GetIniValue(IniFile, "Recruits", "Recruit6")
GuiControl,, Recruit7, % GetIniValue(IniFile, "Recruits", "Recruit7")
...
GenerateConfig:
	...
	FileAppend, [Recruits]`n, %IniFile%
    SaveOperatorSettings(IniFile, "Recruit", Recruit, Recruit1)
    SaveOperatorSettings(IniFile, "Recruit2", Recruit2, Recruit22)
    SaveOperatorSettings(IniFile, "Recruit3", Recruit3, Recruit33)
    SaveOperatorSettings(IniFile, "Recruit4", Recruit4, Recruit44)
    SaveOperatorSettings(IniFile, "Recruit5", Recruit5, Recruit55)
    SaveOperatorSettings(IniFile, "Recruit6", Recruit6, Recruit66)
    SaveOperatorSettings(IniFile, "Recruit7", Recruit7, Recruit77)
